...
import fiap.com.br.meusgames.model.Jogo
...
class ListaGamesActivity : AppCompatActivity() {
    ...
    rvJogos.adapter = ListaGamesAdapter(meusJogos(),this,{
        Toast.makeText(this,
                        it.nome,
    ...
    fun meusJogos() :List<Jogo>{
        return listOf(
                Jogo(R.drawable.doom, "DOOM",  2019, "Aqui vou falar do jogo")
        )
    }
